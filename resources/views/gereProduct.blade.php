                ...
                <div class="p-6 text-gray-900">
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            /* Custom CSS for Products List and Filter */
                            h1.text-center {
                                font-size: 2.5rem;
                                font-weight: 600;
                                color: #333;
                    ...
                    <body>
                        <div class="container mt-5">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h1 class="text-center mb-0">Products List</h1>
                                <a href="{{route('createProduct')}}" class="btn btn-primary">Ajouter Produit</a>
                            </div>
                                ...
                                @foreach($products as $product)
                                    <div class="product-card" data-category="{{ $product->category }}">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <a href="{{Route('showProduct', $product->id)}}" class="btn btn-secondary mt-2">Modifier</a>
                                            <a href="{{Route('deleteProduct',$product->id)}}" class='btn btn-danger'>suprimer</a>
